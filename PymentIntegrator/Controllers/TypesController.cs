    ...
    public class TypesController : ApiController
    {
        ...
        public DataSet ConfigData(ConfigData vc)
        {
            ...
            try
            {
                ...
                SqlParameter vfid2 = new SqlParameter();
                vfid2.ParameterName = "@includeFeatureName";
                vfid2.SqlDbType = SqlDbType.Int;
                vfid2.Value = vc.includeFeatureName;
                cmd.Parameters.Add(vfid2);
