...
var mycrtl1 = myapp1.controller('myCtrl', function ($scope, $http, $localStorage, $uibModal) {
   ...
   // $scope.Roleid = $scope.userdetails[0].roleid;
    ...
    $scope.GetLicenseCat = function () {
        $http.get('/api/Licenses/GetLicenceCatergories').then(function (res, data) {
    ...
    $scope.GetLicenseConfigDetails = function (licTypeId) {
        $http.get('/api/Licenses/GetLicenseConfigDetails?licTypeId=' + licTypeId).then(function (res, data) {
    ...
    $scope.saveNewLicense = function (License) {
        ...
        var req = {
            method: 'POST',
            url: '/api/Licenses/SaveLicenseDetails',
            data: NewLicense
        }
