...
var ctrl = app.controller('myCtrl', function ($scope, $http, $localStorage, $uibModal, $upload, $timeout, fileReader, $filter) {
    ...
    $scope.save = function (User, flag, role) {
        ...
        var U = {
            ...
            ReferenceId: User.ReferenceCode,
            AoiId: $scope.cmp.Id,
            Telephone: User.Telephone,
            EmailId: User.EmailId,
            Address: User.Address,
            Fax: User.ContactNo1,
            CountryId: $scope.cmp.Id,
            ZipCode: User.ZipCode,//($scope.mgr == null) ? null : $scope.mgr.Id,  
        ...
        var req = {
            method: 'POST',
            url: '/api/Company/CustomerDetails',
            data: U
        }
