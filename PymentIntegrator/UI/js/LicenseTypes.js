...
var mycrtl1 = myapp1.controller('myCtrl', function ($scope, $http, $localStorage, $uibModal) {
    ...
    $scope.getLicenseTypes = function (selCat) {
        ...
        $http.get('/api/Licenses/GetLicenseTypes?catid=' + selCat.Id).then(function (res, data) {
    ...
    $scope.GetLicenseCategoriess = function () {
        ...
        $http.get('/api/licenses/getLicenseDetails').then(function (res, data) {
    ...
    $scope.saveLicenseType = function (licenseType, flag) {
        ...
        var req = {
            method: 'POST',
            url: '/api/Licenses/SaveLicenseType',
    ...
    $scope.getselectval = function (seltype) {
        ...
        $http.get('/api/Licenses/getlicense?Subcatid=' + grpid).then(function (res, data) {
    ...
    $scope.GetLicenseFeatures = function () {
        ...
        $http.get('/api/Licenses/getLicenseDetails?catId' + selCat.Id).then(function (res, data) {
    ...
    $scope.Save = function (currSelLicense) {
        ...
        var req = {
            method: 'POST',
            url: ('/api/Licenses/SaveLicensePricing'),
            //headers: {
